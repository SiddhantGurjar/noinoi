...
vu2 = game:GetService("VirtualInputManager")
vu3 = game:GetService("LocalizationService")
vu4 = game:GetService("CollectionService")
vu5 = game:GetService("ReplicatedStorage")
vu6 = game:GetService("VirtualUser")
vu7 = game:GetService("HttpService")
v8 = game:GetService("RunService")
vu9 = game:GetService("Lighting")
vu10 = game:GetService("Players")
vu11 = game:GetService("CoreGui")
vu12 = workspace.CurrentCamera
vu13 = v8.Stepped
vu14 = vu10.LocalPlayer
vu15 = vu14:WaitForChild("Data")
vu15:WaitForChild("LastSpawnPoint")
vu15:WaitForChild("SpawnPoint")
vu16 = vu15:WaitForChild("Fragments")
vu17 = vu15:WaitForChild("Subclass")
vu18 = vu15:WaitForChild("FruitCap")
vu19 = vu15:WaitForChild("Level")
vu20 = vu15:WaitForChild("Beli")
vu21 = workspace:WaitForChild("Map")
vu22 = workspace:WaitForChild("NPCs")
vu23 = workspace:WaitForChild("Boats")
vu24 = workspace:WaitForChild("SeaBeasts")
vu25 = workspace:WaitForChild("Enemies")
vu26 = workspace:WaitForChild("Characters")
vu27 = workspace:WaitForChild("_WorldOrigin")
vu28 = vu27:WaitForChild("Locations")
vu27:WaitForChild("PlayerSpawns")
vu29 = vu5:WaitForChild("Remotes")
vu30 = vu5:WaitForChild("Modules")
vu31 = vu30:WaitForChild("Net")
vu82 = nil
vu464 = function() return false end
Workspace = game:GetService("Workspace")
...
local oldMakeTab = v466.MakeTab
v466.MakeTab = function(self,config)
...
local v484 = v466:MakeTab({Translate("Discord"), "info"})
local v485 = v466:MakeTab({Translate("Farm"), "home"})
local v487 = v466:MakeTab({Translate("Quest/Items"), "swords"})
local v486 = v466:MakeTab({Translate("Fishing"), "rbxassetid://127664059821666"})
local v489 = v466:MakeTab({Translate("Sea"), "waves"})
local v490 = v466:MakeTab({Translate("Race V4"), "crown"})
local v498 = v466:MakeTab({Translate("Islands"), "palmtree"})
local v491 = v466:MakeTab({Translate("Fruits/Raid"), "cherry"})
local v497 = v466:MakeTab({Translate("Stats"), "Signal"})
local v493 = v466:MakeTab({Translate("Teleport"), "locate"})
local v499 = v466:MakeTab({Translate("Status"), "Scroll"})
local v494 = v466:MakeTab({Translate("Visual"), "user"})
local v495 = v466:MakeTab({Translate("Shop"), "shoppingCart"})
local v496 = v466:MakeTab({Translate("Misc"), "settings"})
    ...
    while AutoStats do
        ...
        if statsFolder then
            ...
            if points and points.Value > 0 then
                -- Ver quantos Stats estão ativos
                local EnabledStats = {}
